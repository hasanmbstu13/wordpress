...
function cms2cms_wp_admin_style() {
    ...
    wp_register_script( 'localization_cms', './js/cms2cms.js' );
    load_plugin_textdomain( 'cms2cms-migration', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
    ...
    $translation_array = array(
        ...
        'To improve migration results please select one of the detected menu.' => __('To improve migration results please select one of the detected menu.', $fileStart),
        'Unable to detect menu. Please make sure that specified website URL is valid or click Get Estimate to proceed.' => __('Unable to detect menu. Please make sure that specified website URL is valid or click Get Estimate to proceed.', $fileStart)
    );
    wp_localize_script( 'localization_cms', 'localization_cms', $translation_array );
    wp_enqueue_script( 'localization_cms' );
}
